...
The dataset is the same as the one used in the first practical work session: [**Practical work with `matplotlib` (1/2)**](session_1_f.md).
...
#### Question 1.1: Ordered Bar Chart
...
#### Question 1.4: Dot Strip Plot

**Task**: Create a dot strip plot showing nominalGDP ranges for different regions in 2019.

**Requirements**:

- Group by regions (use the non-country entities as regional aggregates)
...
#### Question 1.6: Ordered Proportional Symbol
