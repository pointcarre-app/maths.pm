...
def render_question(*, x, factor):
    ...
    statement = f"Convertir en heures une durée de ${x.latex()}$ minutes. Répondre sous la forme d'une fraction irréductible."
...
missive(
    {
        ...
        "answer": {
            ...
            "simplified_latex": answer["maths_object"].simplified().latex() + " h",
