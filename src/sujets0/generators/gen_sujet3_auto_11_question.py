...
def generate_components(difficulty, seed=SEED) -> dict[str, tm.MathsObject]:
    """[sujets0][gén][sujet-3][automatismes][question-11]
    >>> generate_components(None, 0)
    {'v': Symbol(s='V'), 'h': Symbol(s='h'), 'r': Symbol(s='r'), 'expr': Equality(l=Symbol(s='V'), r=Mul(l=Mul(l=Constant(c='Pi'), r=Pow(base=Symbol(s='r'), exp=Integer(n=2))), r=Symbol(s='h')))}
    """
...
def render_question(*, v, h, r, expr):
    ...
    >>> statement["statement"]
    "Le volume $V$ d\'un cylindre de hauteur $h$ et de rayon $r$ est $V = \\\\pi r^{2}h$. Isoler $h$."
    """
