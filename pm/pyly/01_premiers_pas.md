...
<ul>
<li><a href="#premiers-pas-avec-python">👣 Premiers pas avec Python</a><ul>
<li><a href="#affichages-avec-la-fonction-print">📺 Affichages avec la fonction print</a></li>
<li><a href="#calculatrice">🧮 Calculatrice</a><ul>
<li><a href="#addition-et-soustraction-avec-et-">Addition et soustraction avec + et -</a></li>
<li><a href="#multiplication-et-division-et">Multiplication et division * et /</a></li>
<li><a href="#division-euclidienne-avec-et">Division euclidienne avec // et %</a></li>
<li><a href="#priorite-des-operations">Priorité des opérations</a></li>
</ul>
</li>
...
<li><a href="#example-maths-for-later">Example maths for later</a><ul>
<li><a href="#graph-yaml">Graph (YAML)</a></li>
<li><a href="#table-de-variations-yaml-avec-classe">Table de variations (YAML avec classe)</a></li>
</ul>
</li>
</ul>
</li>
      ...
      <div class="max-w-[640px] mx-auto md:py-12 bg-base-100">
        ...
        <!-- Fragments (rendered via partials) -->
              ...
              <div class="fragment-wrapper " data-f_type="h1_">
                <h1 id="premiers-pas-avec-python"
    class="fragment text-2xl sm:text-3xl md:text-4xl font-bold"
    data-f_type="h1_">👣 Premiers pas avec Python</h1>
              </div>
              ...
              <div class="fragment-wrapper lead" data-f_type="p_">
                <p class="fragment" data-f_type="p_">Ces premiers pas ne deviendront pas une chorégraphie virale, mais ils t'apprendront quelque chose. Bref, tout l'opposé de Tiktok.</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="image_">
                <div class="fragment image" data-f_type="image_">
  <img src="/images/computer-desk-old-169.jpg" alt="" width="1200" height="675" />
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="affichages-avec-la-fonction-print"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">📺 Affichages avec la fonction <code>print</code></h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Lorsque l'on code, tout se passe à l'intérieur de la machine. On a donc besoin d'indiquer au programme si l'on souhaite qu'il affiche des valeurs à l'écran. En Python, c'est la fonction <code>print</code> qui permet de réaliser un affichage.</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="codex_">
                <div class="fragment codex" data-f_type="codex_" data-codex-container>
  <div class="skeleton h-6 w-28 mb-2"></div>
  <div class="skeleton h-40 w-full rounded mb-2"></div>
  <textarea class="codex-editor hidden" data-language="python"># _________________foreground_script_________________
...
# _________________private_checks_________________
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="calculatrice"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">🧮 Calculatrice</h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h3_">
                <h3 id="addition-et-soustraction-avec-et-"
    class="fragment text-lg sm:text-xl md:text-2xl font-medium"
    data-f_type="h3_">Addition et soustraction avec <code>+</code> et <code>-</code></h3>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h3_">
                <h3 id="multiplication-et-division-et"
    class="fragment text-lg sm:text-xl md:text-2xl font-medium"
    data-f_type="h3_">Multiplication et division <code>*</code> et <code>/</code></h3>
              </div>
...
# _________________private_checks_________________
              ...
              <div class="fragment-wrapper " data-f_type="h3_">
                <h3 id="division-euclidienne-avec-et"
    class="fragment text-lg sm:text-xl md:text-2xl font-medium"
    data-f_type="h3_">Division euclidienne avec <code>//</code> et <code>%</code></h3>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h3_">
                <h3 id="priorite-des-operations"
    class="fragment text-lg sm:text-xl md:text-2xl font-medium"
    data-f_type="h3_">Priorité des opérations</h3>
              </div>
              ...
              <div class="fragment-wrapper bg-secondary" data-f_type="p_">
                <p class="fragment" data-f_type="p_">En utilisant la fonction <code>print</code>, calcule combien d'heures tu as passé à dormir si tu dors 8h par nuit depuis que t'es né (prends ton âge en années).</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="q_">
                <blockquote class="fragment" data-f_type="q_">
...
# _________________private_checks_________________
    ...
    data-f_type="h2_">📦 Variables</h2>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Comme en maths, tes boîtes préférées</p>
              </div>
              ...
              <div class="fragment-wrapper bg-white" data-f_type="p_">
                <p class="fragment" data-f_type="p_">Plutôt que de tout calculer d'un coup, on peut stocker des valeurs dans des variables. C'est comme créer des raccourcis !</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Par exemple :</p>
              </div>
  ...
  <pre class="fragment-code"><code class="language-python">age = 16                  # Mon âge
...
print(&#34;J&#39;ai dormi environ&#34;, total, &#34;heures dans ma vie !&#34;)
              ...
              <div class="fragment-wrapper bg-white" data-f_type="p_">
                <p class="fragment" data-f_type="p_">T'inquiète pas si tu comprends pas tout, on va y aller step by step.</p>
              </div>
...
# _________________private_checks_________________
              ...
              <div class="fragment-wrapper bg-secondary" data-f_type="p_">
                <p class="fragment" data-f_type="p_">Crée des variables pour calculer combien de minutes tu passes sur ton téléphone en une année si tu y passes 3 heures par jour. Utilise des noms de variables qui ont du sens !</p>
              </div>
...
# _________________private_checks_________________
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="commentaires"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">💬 Commentaires</h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Soit $a$ un réel non nul. Calculer l'unique antécédent de $0$ par la fonction $f$ définie sur $\mathbb{R}$ par $f(x)=ax+b$.</p>
              </div>
              ...
              <div class="fragment-wrapper i-maths fromhere" data-f_type="maths_">
                <div class="fragment form-control" data-f_type="maths_">
  <label class="label">
    <span class="label-text"></span>
  </label>
  <input type="text" class="input input-bordered" placeholder="Enter your answer..." />
</div>
              </div>
    ...
    data-f_type="h2_">🔁 Récap</h2>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">&lt;!-- # Variables et affichages</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Pour découvrir ce langage de programmation, utilisons Python comme une calculatrice !</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="quelques-calculs"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Quelques calculs</h2>
              </div>
              ...
              <div class="fragment-wrapper nm li-mb-more bg-white" data-f_type="ul_">
                <ul class="fragment" data-f_type="ul_">
  <ul class="">
<li>Blablablablabl</li>
<li>Blablabla</li>
</ul>
</ul>
              </div>
...
script_path: &#34;intro/calculatrice_4_ope.py&#34;
              ...
              <div class="fragment-wrapper bg-secondary" data-f_type="p_">
                <p class="fragment" data-f_type="p_">En utilisant la fonction <code>print</code>, et l'opérateur <code>+</code>, écris du code qui calcule le nombre de jours au cours de la décennie 2010-2019.</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">(ca envoie le code)</p>
              </div>
...
script_path: &#34;intro/calculatrice_4_ope_question_0.py&#34;
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="example-maths-for-later"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Example maths for later</h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="code_">
                <div class="fragment mockup-code" data-f_type="code_">
  <pre class="fragment-code"><code class="language-yaml">mathPCAVersion: 1
mask: x_0=
nature: give_formula
expression: -b/a
...
&amp;lt;vector-graph width=&#34;300&#34; height=&#34;200&#34;&amp;gt;&amp;lt;/vector-graph&amp;gt;
    ...
    data-f_type="h3_">Graph (YAML)</h3>
              ...
              <div class="fragment-wrapper " data-f_type="graph_">
                <div class="fragment"
     data-f_type="graph_"
     data-graph='{"graphPCAVersion": 1, "title": "Graphe d\u0027exemple"}'></div>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h3_">
                <h3 id="table-de-variations-yaml-avec-classe"
    class="fragment text-lg sm:text-xl md:text-2xl font-medium"
    data-f_type="h3_">Table de variations (YAML avec classe)</h3>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_"><code>yaml {.table-variations}
headers: [x, f(x)]
rows:
  - [-2, 5]
  - [0, 1]
