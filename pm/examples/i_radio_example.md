...
<ul>
<li><a href="#basic-i-radio-button-questions">Basic i-Radio Button Questions</a><ul>
<li><a href="#visual-behavior">Visual Behavior</a></li>
<li><a href="#example-1-simple-binary-choice">Example 1: Simple Binary Choice</a></li>
<li><a href="#example-2-with-always-visible-comment">Example 2: With Always-Visible Comment</a></li>
<li><a href="#example-3-multiple-correct-answers">Example 3: Multiple Correct Answers</a></li>
<li><a href="#example-4-with-latex-math">Example 4: With LaTeX Math</a></li>
<li><a href="#example-5-french-question">Example 5: French Question</a></li>
<li><a href="#flag-system-reference">Flag System Reference</a></li>
<li><a href="#markdown-syntax">Markdown Syntax</a></li>
      ...
      <div class="max-w-[640px] mx-auto md:py-12 bg-base-100">
        ...
        <!-- Fragments (rendered via partials) -->
              ...
              <div class="fragment-wrapper " data-f_type="h1_">
                <h1 id="basic-i-radio-button-questions"
    class="fragment text-2xl sm:text-3xl md:text-4xl font-bold"
    data-f_type="h1_">Basic i-Radio Button Questions</h1>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">This demonstrates the basic i-radio fragment system with flag-based answer validation.</p>
              </div>
  ...
  <ul class="">
<li><strong>Initial state</strong>: All buttons appear as soft primary outline buttons</li>
<li><strong>On click</strong>: Button turns green (correct) or red (wrong)</li>
<li><strong>Other buttons</strong>: Reset to soft outline state when a new answer is selected</li>
</ul>
</ul>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="example-1-simple-binary-choice"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Example 1: Simple Binary Choice</h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Which programming language are we learning?</p>
              </div>
  ...
  <div id="radio-feedback-6"
    ...
    <div class="alert">
      <span id="radio-feedback-text-6"></span>
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="example-2-with-always-visible-comment"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Example 2: With Always-Visible Comment</h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">What is 2 + 2?</p>
              </div>
  ...
  <div id="radio-feedback-9"
       class="opacity-0 scale-95 -translate-y-2 pointer-events-none">
    <div class="alert">
      <span id="radio-feedback-text-9"></span>
    </div>
  </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">The last item without a flag is always visible as a comment.</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="example-3-multiple-correct-answers"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Example 3: Multiple Correct Answers</h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Which of these are even numbers?</p>
              </div>
  ...
  <div id="radio-feedback-13"
       class="opacity-0 scale-95 -translate-y-2 pointer-events-none">
    <div class="alert">
      <span id="radio-feedback-text-13"></span>
    </div>
  </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Multiple answers can be marked as correct (flag 20).</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="example-4-with-latex-math"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Example 4: With LaTeX Math</h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Solve: $x^2 - 4 = 0$</p>
              </div>
  ...
  <div id="radio-feedback-17"
       class="opacity-0 scale-95 -translate-y-2 pointer-events-none">
    <div class="alert">
      <span id="radio-feedback-text-17"></span>
    </div>
  </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">LaTeX expressions work seamlessly in radio buttons.</p>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="example-5-french-question"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Example 5: French Question</h2>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Quelle est la capitale de la France?</p>
              </div>
  ...
  <div id="radio-feedback-21"
       class="opacity-0 scale-95 -translate-y-2 pointer-events-none">
    <div class="alert">
      <span id="radio-feedback-text-21"></span>
    </div>
  </div>
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="flag-system-reference"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Flag System Reference</h2>
              </div>
    ...
    <table class="fragment-table table">
        ...
        <thead>
          <tr>
            <th>Flag</th><th>Meaning</th><th>Visual Result</th>
          </tr>
        </thead>
      ...
      <tbody>
          ...
          <tr>
            <td>20</td><td>Correct answer</td><td>Green button (btn-success)</td>
          </tr>
        
          <tr>
            <td>21</td><td>Wrong answer</td><td>Red button (btn-error)</td>
          </tr>
        
          <tr>
            <td>-1 or none</td><td>Comment</td><td>Always visible text below buttons</td>
          </tr>
              ...
              <div class="fragment-wrapper " data-f_type="h2_">
                <h2 id="markdown-syntax"
    class="fragment text-xl sm:text-2xl md:text-3xl font-semibold"
    data-f_type="h2_">Markdown Syntax</h2>
              </div>
  ...
  <pre class="fragment-code"><code class="language-markdown">- Answer text{:flag}
{: .i-radio}
</code></pre>
</div>
              </div>
              ...
              <div class="fragment-wrapper " data-f_type="p_">
                <p class="fragment" data-f_type="p_">Where <code>flag</code> is 20 (correct) or 21 (wrong).</p>
              </div>
  ...
  <!-- Product Settings Debug (collapsible) -->
    ...
    <div class="collapse collapse-arrow bg-base-100 mt-4">
      ...
      <div class="collapse-title text-sm font-medium">
        Product Settings: <span class="badge badge-primary badge-sm">examples</span>
          ...
          <div class="grid gap-4">
            ...
            <div class="card bg-base-200 p-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                <div>
                  <strong>Name:</strong> examples
                </div>
                <div>
                  <strong>Title:</strong> Examples &amp; Documentation
                </div>
                <div>
                ...
                <div class="mt-2">
                  ...
                  <p class="text-sm mt-1">Collection of examples demonstrating various PM fragment features, including i-radio interactive questions.</p>
                </div>
  ...
  "examples": {
    "description": "Test and example files for PM features",
    "enabled": "true"
  }
}</pre>
              </div>
  ...
  "description": "Collection of examples demonstrating various PM fragment features, including i-radio interactive questions.",
  "is_enabled": true,
  "local_path": "#",
  "name": "examples",
  "product": {
    ...
    "local_path": "#",
    "name": "examples",
    "owner_rdb": "Documentation",
    "owner_url": "#",
    "source_link": null,
    "subtitle_html": "Interactive examples and test cases",
    "tags": [
      "examples",
      "documentation",
      "testing",
    ...
    "title_html": "Examples \u0026 Documentation"
  },
